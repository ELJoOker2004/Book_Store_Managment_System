...
#----------------------------------------------
    #books details: images / bookname / author / books alignment
        ...
        for image_path, book_name, book_author  in image_paths[:12]:
            ...
            # book name
            bookName = tk.Label(txt, text=name, font=("Times New Roman", 14))
            ...
            # author name
            bookAuthor = tk.Label(txt, text=f"By: {author}", font=("Times New Roman italic", 12),anchor="sw" )
